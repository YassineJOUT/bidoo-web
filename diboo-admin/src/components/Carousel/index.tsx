                                    ...
                                    <div className="modal-body">
                                        <div className="row">
                                            ...
                                            <div className="col-lg-6">
                                                ...
                                                <h4 className="mt-0 header-title">Restaurant Banner</h4><br/>
                                            ...
                                            <div className="col-lg-6">
                                                <div className="card-body">
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <input id="metakeywords" name="englishTitle" type="text" className="form-control"/>
                                                    </div>

                                                    <div className="form-group">
                                                        <label >Frensh banner title</label>
                                                        <input id="metakeywords" name="frenshTitle" type="text" className="form-control"/>
                                                    </div>
                                                     
                                                      
                                                    <div className="form-group">
                                                        <label >Banner hyper link</label>
                                                        <input id="metakeywords" name="hyperLink" type="text" className="form-control"/>
                                                    </div>
