...
const DisplayDetailsForm: React.SFC<{ Id: string }> = (props) => {
    ...
    function getContent(step: Number) {
        ...
        switch (step) {
          ...
          case 2: return (<div className="form-group" >
                            ...
                            <div className="card-body mini-stat-img">
                                ...
                                <ul className="nav nav-tabs" role="tablist">
                                        <li className="nav-item">
                                            <a className="nav-link" data-toggle="tab" href="#home" role="tab" aria-selected="false">
                                                <span className="d-block d-sm-none"><i className="fas fa-home"></i></span>
                                                <span className="d-none d-sm-block">Contact info</span>    
                                            </a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link active" data-toggle="tab" href="#profile" role="tab" aria-selected="true">
                                    ...
                                    <div className="tab-content">
                                        ...
                                        <div className="tab-pane p-3 active" id="profile" role="tabpanel">
                                        {getContent(1)}
                                        </div>
